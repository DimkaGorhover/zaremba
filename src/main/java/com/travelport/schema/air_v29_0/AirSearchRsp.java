...
import com.travelport.schema.rail_v29_0.RailFareIDList;
import com.travelport.schema.rail_v29_0.RailFareList;
import com.travelport.schema.rail_v29_0.RailFareNoteList;
import com.travelport.schema.rail_v29_0.RailJourneyList;
import com.travelport.schema.rail_v29_0.RailPricingSolution;
import com.travelport.schema.rail_v29_0.RailSegmentList;
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.travelport.com/schema/air_v29_0}BaseAvailabilitySearchRsp">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}FareNoteList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}ExpertSolutionList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}RouteList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}AlternateRouteList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}AlternateLocationDistanceList" minOccurs="0"/>
 *         &lt;choice minOccurs="0">
 *           &lt;element ref="{http://www.travelport.com/schema/air_v29_0}AirPricingSolution" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element ref="{http://www.travelport.com/schema/air_v29_0}AirPricePointList" minOccurs="0"/>
 *         &lt;/choice>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailSegmentList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailJourneyList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailFareNoteList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailFareIDList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailFareList" minOccurs="0"/>
 *         &lt;element ref="{http://www.travelport.com/schema/rail_v29_0}RailPricingSolution" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends BaseAvailabilitySearchRsp
{
    ...
    @XmlElement(name = "RailSegmentList", namespace = "http://www.travelport.com/schema/rail_v29_0")
    protected RailSegmentList railSegmentList;
    @XmlElement(name = "RailJourneyList", namespace = "http://www.travelport.com/schema/rail_v29_0")
    protected RailJourneyList railJourneyList;
    @XmlElement(name = "RailFareNoteList", namespace = "http://www.travelport.com/schema/rail_v29_0")
    protected RailFareNoteList railFareNoteList;
    @XmlElement(name = "RailFareIDList", namespace = "http://www.travelport.com/schema/rail_v29_0")
    protected RailFareIDList railFareIDList;
    @XmlElement(name = "RailFareList", namespace = "http://www.travelport.com/schema/rail_v29_0")
    protected RailFareList railFareList;
    @XmlElement(name = "RailPricingSolution", namespace = "http://www.travelport.com/schema/rail_v29_0")
