 ...
 *         &lt;element ref="{http://www.travelport.com/schema/common_v29_0}FormOfPayment" maxOccurs="2" minOccurs="0"/>
...
public class AirExchangeTicketBundle {
    ...
    @XmlElement(name = "TicketNumber", namespace = "http://www.travelport.com/schema/common_v29_0", required = true)
