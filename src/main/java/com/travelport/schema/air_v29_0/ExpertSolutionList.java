 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}ExpertSolution" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ExpertSolutionList {
     ...
     * This is why there is not a <CODE>set</CODE> method for the expertSolution property.
     * 
     * <p>
    ...
    public List<ExpertSolution> getExpertSolution() {
        if (expertSolution == null) {
            expertSolution = new ArrayList<ExpertSolution>();
        }
