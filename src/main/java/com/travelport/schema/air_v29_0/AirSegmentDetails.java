 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}PassengerDetailsRef" maxOccurs="unbounded"/>
 *         &lt;element ref="{http://www.travelport.com/schema/air_v29_0}FareDetailsRef" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="OperatingCarrier" type="{http://www.travelport.com/schema/common_v29_0}typeCarrier" />
 *       &lt;attribute name="FlightNumber" use="required" type="{http://www.travelport.com/schema/common_v29_0}typeFlightNumber" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class AirSegmentDetails {
    ...
    @XmlElement(name = "FareDetailsRef")
    protected List<FareDetailsRef> fareDetailsRef;
    ...
    /**
     * Gets the value of the fareDetailsRef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fareDetailsRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFareDetailsRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FareDetailsRef> getFareDetailsRef() {
        if (fareDetailsRef == null) {
            fareDetailsRef = new ArrayList<FareDetailsRef>();
        }
        return this.fareDetailsRef;
    }
