 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.travelport.com/schema/common_v29_0}Distance"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Key" use="required" type="{http://www.travelport.com/schema/common_v29_0}typeRef" />
 *       &lt;attribute name="SearchLocation" use="required" type="{http://www.travelport.com/schema/common_v29_0}typeIATACode" />
 *       &lt;attribute name="AlternateLocation" use="required" type="{http://www.travelport.com/schema/common_v29_0}typeIATACode" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class AlternateLocationDistance {
    ...
    @XmlElement(name = "Distance", namespace = "http://www.travelport.com/schema/common_v29_0", required = true)
