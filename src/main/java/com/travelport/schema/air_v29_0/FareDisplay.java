...
public class FareDisplay {
     ...
     *     
     */
    public Boolean getEligibilityRestricted() {
     ...
     *     
     */
    public Boolean getStopoversRestricted() {
     ...
     *     
     */
    public Boolean getTransfersRestricted() {
     ...
     *     
     */
    public Boolean getBlackoutsExist() {
     ...
     *     
     */
    public Boolean getAccompaniedTravel() {
