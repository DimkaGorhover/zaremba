...
public class ServiceRuleType {
    ...
    public static class ApplicationRules {
         ...
         *     
         */
        public Boolean getRequiredForAllTravelers() {
         ...
         *     
         */
        public Boolean getRequiredForAllSegments() {
         ...
         *     
         */
        public Boolean getRequiredForAllSegmentsInOD() {
         ...
         *     
         */
        public Boolean getUnselectedOptionRequired() {
         ...
         *     
         */
        public Boolean getSecondaryOptionCodeRequired() {
    ...
    public static class ModifyRules {
        ...
        public static class ModifyRule {
             ...
             *     
             */
            public boolean getAutomaticallyAppliedOnAdd() {
