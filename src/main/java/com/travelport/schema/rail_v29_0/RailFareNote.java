 ...
 *       &lt;attribute name="NoteName" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "RailFareNote")
public class RailFareNote {

    @XmlValue
    protected String value;
    @XmlAttribute(name = "Key", required = true)
    protected String key;
    @XmlAttribute(name = "NoteName", required = true)
