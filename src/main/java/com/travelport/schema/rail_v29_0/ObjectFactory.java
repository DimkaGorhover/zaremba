 ...
 * generated in the com.travelport.schema.rail_v29_0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _FulFillmentType_QNAME = new QName("http://www.travelport.com/schema/rail_v29_0", "FulFillmentType");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.travelport.schema.rail_v29_0
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/rail_v29_0", name = "FulFillmentType")
    public JAXBElement<String> createFulFillmentType(String value) {
        return new JAXBElement<String>(_FulFillmentType_QNAME, String.class, null, value);
    }
